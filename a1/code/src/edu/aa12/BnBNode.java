...
public class BnBNode{
    ...
    public final double costOfIncludedEdges;

    public BnBNode(BnBNode parent, Edge edge, boolean edgeIncluded, Graph graph){
        this.parent = parent;
        ...
        double cost = 0.0;
        if (parent!=null) cost += parent.costOfIncludedEdges;
        if (edgeIncluded) cost += graph.getLength(edge);
        this.costOfIncludedEdges = cost;
    }
