...
Note that only half of the constraints are needed due to the symmetry of the subset formulation\footnote{Observation 10.2, Chapter 10, Wolsey.}, but the number of constraints will still be exponential in $n$.
